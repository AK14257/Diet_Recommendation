...
import 'package:ubereatsdriver/controller/sevices/authServices/mobileAuthServices.dart';
...
class _mobileLoginScreenState extends State<mobileLoginScreen> {
  ...
  bool receiveOTPButtomPressed = false;
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      setState(() {
        receiveOTPButtomPressed = false;
      });
    });
  }
        ...
        children: [
          ...
          ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                  backgroundColor: blue, minimumSize: Size(90.w, 6.h)),
              child: receiveOTPButtomPressed
          ...
          Text(
            'By proceeding you consent to get calls, Whatsapp or SMS messages, including by automated means, from HealthyBites and its affiliates to the number provided.',
